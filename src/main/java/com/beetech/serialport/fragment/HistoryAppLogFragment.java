...
public class HistoryAppLogFragment extends Fragment {
    ...
    private static final String TAG = "HistoryModuleBufFragment";
    ...
    private List<AppLog> loadData(int startPosition, int count) {
        ...
        // (2)执行查询
        dataList = dao.queryList(null, null, null, null, null,
                "_id desc limit " + String.valueOf(count)+ " offset " + startPosition, null);
        // (3)关闭数据库
